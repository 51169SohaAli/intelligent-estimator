      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <button 
              type="button" 
              className="flex items-center justify-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 active:scale-[0.98] transition-all shadow-2xs"
            >
