...
interface HeaderProps {
  ...
  onOpenCreateModal?: () => void; // 🔑 Callback prop type assignment
}
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200/80 px-6 flex items-center justify-between w-full shadow-sm relative">
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        {/* 🎨 MATCHED: Button uses bg-indigo-950 to perfectly pull the exact background identity of your sidebar */}
        <button
        ...
        <div className="relative">
          ...
          >
            {/* 🎨 MATCHED: Avatar container uses bg-purple-600 to mirror the exact profile layout circle color inside the sidebar */}
            ...
            <div className="hidden sm:block text-left">
              ...
              <p className="text-[9px] text-slate-400 font-medium tracking-wide">Developer Account</p>
            </div>
          </button>
            ...
            <>
              ...
              <div className="absolute right-0 mt-3 w-48 bg-white border border-slate-200 rounded-xl shadow-xl py-1.5 z-50 text-slate-700">
                <div className="px-4 py-2 border-b border-slate-100 bg-slate-50/50">
                  ...
                  <p className="text-xs font-semibold text-slate-700 truncate">soha.ali@example.com</p>
                </div>
